/**
 * BUILD-301C — RF auth + membership helpers for OneDrive storage API routes.
 * Same pattern as Dropbox; kept in onedrive package to avoid cross-provider coupling.
 */
