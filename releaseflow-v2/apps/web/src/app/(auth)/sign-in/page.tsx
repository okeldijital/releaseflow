  ...
  return (
    <>
      <div className="mb-6 text-center">
        <h1 className="text-[22px] font-semibold text-text-900 tracking-tight">Welcome back</h1>
        <p className="mt-1 text-sm text-text-500">Sign in to your ReleaseFlow account</p>
      </div>
        ...
        <div className="space-y-1">
          ...
          <div className="flex justify-end pt-0.5">
            <Link
              ...
              className="text-xs text-text-400 hover:text-primary-500 transition-colors duration-150"
            >
              Forgot password?
            </Link>
          </div>
