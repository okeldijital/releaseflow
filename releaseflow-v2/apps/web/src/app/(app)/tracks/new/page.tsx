...
function BasicsStep({
  ...
  remixErrors: { originalArtists?: string; remixArtists?: string; featuredArtists?: string };
  setRemixErrors: Dispatch<SetStateAction<{ originalArtists?: string; remixArtists?: string; featuredArtists?: string }>>;
