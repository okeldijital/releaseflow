...
export default function CompletePage() {
  ...
  return (
    <div className="text-center">
      ...
      <h1 className="text-[2rem] font-semibold tracking-tight text-surface-50">You&apos;re all set.</h1>
      ...
      <button
        ...
        className="mt-10 w-full h-12 rounded-xl bg-primary-500 text-white font-semibold text-[15px] hover:bg-primary-400 active:scale-[0.98] transition-all duration-150 shadow-[0_4px_24px_rgba(204,85,0,0.25)] animate-scale-in">
