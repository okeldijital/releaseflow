...
export default function ReleaseDatePage() {
  ...
  return (
    <div className="text-center">
      ...
      <h1 className="text-[1.75rem] font-semibold tracking-tight text-surface-50">When do you want to release it?</h1>
      ...
      <input
        ...
        className="mt-8 block w-full h-14 rounded-xl border border-surface-700 bg-surface-900 px-5 text-[18px] text-surface-50 text-center focus:border-primary-500/60 focus:ring-2 focus:ring-primary-500/20 focus:outline-none transition-all duration-150 [color-scheme:dark]"
