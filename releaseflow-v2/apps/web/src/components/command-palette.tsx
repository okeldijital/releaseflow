...
export function CommandPalette({
  ...
  const navItems: DisplayItem[] = [
    ...
    { id: 'nav-lib', title: 'Library', type: 'dashboard', url: '/library' },
    { id: 'nav-tracks', title: 'Tracks', type: 'track', url: '/library/tracks' },
    { id: 'nav-art', title: 'Artists', type: 'artist', url: '/library/artists' },
    { id: 'nav-media', title: 'Media Files', type: 'dashboard', url: '/media-files' },
    { id: 'nav-cal', title: 'Calendar', type: 'dashboard', url: '/calendar' },
    { id: 'nav-cal-sched', title: 'Schedule', type: 'dashboard', url: '/calendar/schedule' },
    { id: 'nav-cal-dead', title: 'Deadlines', type: 'dashboard', url: '/calendar/deadlines' },
    { id: 'nav-cal-rel', title: 'Releases Calendar', type: 'dashboard', url: '/calendar/releases' },
