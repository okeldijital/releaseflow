...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  secondary:
    'bg-secondary-100 text-text-800 hover:bg-secondary-200 active:bg-secondary-300',
  tertiary:
    'border border-surface-300 bg-white text-text-700 shadow-sm hover:bg-surface-50 hover:border-surface-400 dark:bg-transparent dark:border-surface-600 dark:text-text-200 dark:hover:bg-surface-800',
  outline:
    'border border-surface-300 bg-white text-text-700 shadow-sm hover:bg-surface-50 hover:border-surface-400 dark:bg-transparent dark:border-surface-600 dark:text-text-200 dark:hover:bg-surface-800',
  ghost:
  ...
  'destructive-outline':
    'border border-danger-500 text-danger-600 bg-transparent hover:bg-danger-50 dark:border-danger-400 dark:text-danger-400 dark:hover:bg-danger-950',
};
