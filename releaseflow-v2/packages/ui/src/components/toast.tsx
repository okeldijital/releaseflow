...
export function Toast({
  ...
  return (
    <div
      ...
      aria-live="polite"
      className={`bg-layer-2 rounded-md shadow-raised border border-surface-200 p-4 border-l-4 max-w-sm animate-slide-up
      ...
      <div className="flex items-start gap-3">
        ...
        {dismissible ? (
          <button
            ...
            className="shrink-0 p-1 rounded text-content-label transition-colors duration-100"
          >
            <svg className="h-4 w-4" viewBox="0 0 16 16" fill="currentColor">
