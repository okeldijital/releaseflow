...
export function AppShell({
  ...
  return (
    ...
    <div className="flex h-screen overflow-hidden bg-layer-1 text-content-primary">
      ...
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[200] focus:rounded-lg focus:bg-primary-500 focus:px-4 focus:py-2 focus:text-white focus:text-sm focus:font-medium focus:shadow-lg focus:outline-none"
      >
